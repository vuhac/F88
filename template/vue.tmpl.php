...
/**
*  Features：後台--樣本檔
*  File Name：beadmin_fluid.tmpl.php
*  Author：Barkley
*  Modifier：Damocles
*  Last Modified：2019/08/28
*  Related：
*  Log：2017.1.19 全版寬度的樣板
 */
...
<html lang="en">
  <head>
	...
	<link href="./in/vuetify.min.css" rel="stylesheet">

	<?php echo assets_include(); ?>

	<?php echo $tmpl['extend_head']; ?>
	<script type="text/javascript">
		var domain = "<?php echo $current_url;?>";
		var url = domain+"/api";
		var url = "http://127.0.0.1:8080"; // 本機api
		var url = "https://bedemo.playgt.com/api"; // demo api
	</script>
	...
	<script src="./in/vue.js"></script>
	<script src="./in/vuetify.min.js"></script>
	<script src="./in/httpVueLoader.js"></script>
	<script src="./in/axios.min.js"></script>
