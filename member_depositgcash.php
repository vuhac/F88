...
// File Name:    member_depositgcash.php
// Author:        Barkley
// Modifier：   Damocles
// Related:
...
global $tr;
// 功能標題，放在標題列及meta
$function_title         = $tr['member_depositgcash'];
...
'.$tr['member_depositgcash text1'].'<br>
'.$tr['member_depositgcash text2'].$gcash_cashier_account.$tr['member_depositgcash text3'].'<br>
'.$tr['member_depositgcash text4'].'<br>
</div>';
...
if( $g[0] == 1 ){
    $source_transferaccount_html = $tr['current balance'].'&nbsp;'.money_format('%i', $g[1]->gcash_balance);;
}
else{
...
<div class="row">
    ...
    <div class="col-12 col-md-4">
        <textarea class="form-control validate[maxSize[500]]" id="system_note_input" maxlength="500" placeholder="'.$tr['note'].'('.$tr['max'].'500'.$tr['word'].')">'.$notes_ref.'</textarea>
    </div>
...
<div class="row">
    <div class="col-12 col-md-1"></div>
    <div class="col-12 col-md-6">
        <p>'.$_SESSION['agent']->account.'你好， 人工存入功能，限定管理员、代理商或帐务员才可以操作。请先登入系统。</p>
    </div>
    <div class="col-12 col-md-4"></div>
